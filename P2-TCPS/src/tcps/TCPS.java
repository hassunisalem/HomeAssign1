...
public class TCPS 
{
    ...
    public static Socket configureServer(int numOfClients) throws UnknownHostException, IOException
    {
        ...
        serverSocket = new ServerSocket(PORT + numOfClients);
    ...
    public static class MyThread extends Thread{
        ...
        public MyThread(int numberOfClients){
            this.numberOfClients = numberOfClients;
        }
        public void run() {
            try {
                openSocket = configureServer(this.numberOfClients);
